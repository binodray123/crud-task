        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" style="font-weight: bold;">
                    Edit Company
                    <a href="{{route('companies.index')}}" class="btn btn-danger btn-xs py-1 float-end">Back</a>
                ...
                <form method="POST" action="{{route('companies.update',$company)}}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $company->name}}"  autocomplete="name" >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <img src="{{asset('upload/logo/' .$company->logo)}}" width="300px" height="300px">
